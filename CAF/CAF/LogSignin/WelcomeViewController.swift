...
//
        let LogInButton: UIButton = {
           ...
           // a.tintColor = UIColor(hex: "#ff2d55")
            ...
            a.setTitle(NSLocalizedString("Log in",comment: "login"), for: .normal)
        ...
        let SignUpButton: UIButton = {
            ...
            a.setTitle(NSLocalizedString("Sign Up", comment: "SingUp"), for: .normal)
...
//
    ...
    //    let subtitulo: NSAttributedString = {
            ...
            let together = NSMutableAttributedString (string: NSLocalizedString("together", comment: "inicio"), attributes: [
            ...
            let inThe = NSMutableAttributedString(string: NSLocalizedString(" in the same", comment: "enelmsimo"), attributes: [
            ...
            let spirit = NSMutableAttributedString(string: NSLocalizedString(" Spirit", comment: "espirtu"), attributes: [
  ...
  //      logo.contentMode = .scaleAspectFit
   ...
   //     logo.anchor(top: nil, left: nil, bottom: altarLaber.topAnchor, right: nil, paddingTop: 0, paddingLeft: 0, paddingBottom: -10, paddingRight: 0, width: 23, height: 34)
     //    logo.centerXAnchor.constraint(equalTo: altarLaber.centerXAnchor).isActive = true
        altarLaber.text = "CAF Las Vegas"
        
        view.addSubview(togetherInTheSameLabel)
        
        togetherInTheSameLabel.anchor(top: altarLaber.bottomAnchor, left: nil, bottom: nil, right: nil, paddingTop: 30, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: togetherInTheSameLabel.intrinsicContentSize.width, height: togetherInTheSameLabel.intrinsicContentSize.height)
...
//        withMilionsOfUserLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        ...
        LogInButton.anchor(top: togetherInTheSameLabel.bottomAnchor, left: nil, bottom: nil, right: nil, paddingTop: 20, paddingLeft: 0, paddingBottom: 00, paddingRight: 0, width: 315, height: 44)
