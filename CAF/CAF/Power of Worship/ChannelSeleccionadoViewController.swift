...
class ChannelSeleccionadoViewController: UIViewController {
    ...
    @objc func actiononPlay () {
        ...
        if isPlaying {
            ...
            self.status.text = NSLocalizedString("Loading ....", comment: "")
...
//                    }()
    ...
    var selectChannel: UIButton = {
             ...
             a.setTitle(NSLocalizedString("Select Channel", comment: ""), for: .normal)
    ...
    @objc func selectChannelActive () {
        ...
        advengers.shared.currentChurchInfo.channelActive = cannal?.channelID as! String
...
//
        selectChannel.backgroundColor = UIColor.rgb(red: 247, green: 131, blue: 97)
               ...
               selectChannel.setTitle(NSLocalizedString("Select Channel", comment: ""), for: .normal)
        ...
        func playContent (data: Data)
                  
              {
                  ...
                  do {
                      ...
                      audioPlayer?.play()
                    status.text = NSLocalizedString("Playing ....", comment: "")
                      print("Playing ....")
