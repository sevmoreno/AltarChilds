            ...
            //                        devocional.creationDate = value["creationDate"] as? String
                       ...
                       //                self.photos.append(temporariost)
                         //              self.collectionView.reloadData()
                                    ...
                                    self.devos.sort(by: {$0.creationDate > $1.creationDate})
...
//      }
   ...
   //     default:
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if devos[indexPath.row].message == "video" {
            
            
            performSegue(withIdentifier: "aVideo", sender: self)
