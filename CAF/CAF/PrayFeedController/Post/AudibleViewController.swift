...
class AudibleViewController: UIViewController, AVAudioRecorderDelegate {
    ...
    */
    ...
    override func viewDidLoad() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: NSLocalizedString("Post", comment: ""), style: .plain, target: self, action: #selector(postAudio))
        ...
        view.addSubview(usernameLabel)
               ...
               userProfileImageView.topAnchor.constraint(equalTo: view.topAnchor, constant:70).isActive = true
