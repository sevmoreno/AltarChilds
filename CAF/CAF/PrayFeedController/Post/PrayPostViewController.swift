...
class PrayPostViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    */
    ...
    let cancelButton: UIButton = {
         ...
         cancelButton.setTitle(NSLocalizedString("Done", comment: ""), for: .normal)
...
/*
   ...
   */
     //  navigationItem.rightBarButtonItem = UIBarButtonItem(image: #imageLiteral(resourceName: "gear").withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleLogOut))
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: NSLocalizedString("Post", comment: ""), style: .plain, target: self, action: #selector(postAction))
        
 
        
        
       picker.delegate = self
       textoIngresado.text = NSLocalizedString("What is your prayer?", comment: "")
